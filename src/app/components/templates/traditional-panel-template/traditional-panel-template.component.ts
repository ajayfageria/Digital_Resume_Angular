...
@Component({
  selector: 'app-traditional-panel-template',
  templateUrl: './traditional-panel-template.component.html',
  styleUrls: ['./traditional-panel-template.component.css']
})
export class TraditionalPanelTemplateComponent implements OnInit {
  @Input() resume!: Resume;
