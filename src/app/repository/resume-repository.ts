...
import {getResume, resumeError, resumeLoaded,getResumeById, resumeLoading} from '../reducers';
...
export class ResumeRepository {
  ...
  editResume(data: any, resumeId: string) {
    ...
    getResumeById(id: any, force = false) {
      ...
      resume$.pipe(take(1)).subscribe(data => {
        if (!data || force) {
          this.apiService.getResumeById(id).subscribe((res: any) => {
  ...
  saveOrUpdateImage(image: File, resumeId: string) {
    return this.apiService.saveOrUpdate(image, resumeId).pipe(map((resume) => {
      this.store.dispatch(new UpdateResumeAction(resume));
      return resume;
    }));
  }
  ...
  updateContactDetails(data: any, contactDetailId: string, resumeId: string) {
    return this.apiService.updateContactDetails(data, contactDetailId).pipe(map((resume) => {
      this.store.dispatch(new UpdateContactDetailAction({resume_id: resumeId, contact: resume}));
      return resume;
    }));
  }

  addContactDetails(data: any, resumeId: string) {
    return this.apiService.addContactDetails(data, resumeId).pipe(map((resume) => {
      this.store.dispatch(new AddContactDetailAction({resume_id: resumeId, contact: resume}));
      return resume;
    }));
  }
  ...
  updateViews(data: { views: number }, id: string) {
    return this.apiService.updateViewsCount(data, id).pipe(map((res: any) => {
  ...
  updateEducation(data: any, educationId: string, resumeId: string,) {
  ...
  updateEmploymentHistory(data: any, employmentHistoryId: string, resumeId: string) {
  ...
  updateInterest(data: any, resumeId: string, interestId: string) {
  ...
  updateLanguage(data: any, resumeId: string, languageId: string) {
  ...
  updateIndustrialExposure(data: any, resumeId: string, industrialExposureId: string) {
  ...
  updateAward(data: any, resumeId: string, awardId: string) {
  ...
  updateObjective(data: any, resumeId: string, objectiveId: string) {
  ...
  updateReference(data: any, resumeId: string, referenceId: string) {
  ...
  updateProjectDetail(data: any, resumeId: string, projectDetailId: string) {
  ...
  updateStrength(data: any, resumeId: string, projectDetailId: string) {
  ...
  updateWeakness(data: any, resumeId: string, weaknessId: string) {
